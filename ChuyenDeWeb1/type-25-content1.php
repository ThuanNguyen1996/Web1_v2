...
<html>
    ...
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/type-25-content1.less', 'css/type-25-content1.css');
        ?>
        <link href="css/type-25-content1.css" rel="stylesheet" type="text/css" />
        <script src="js/bootstrap.js" type="text/javascript"></script>
    </head>

    <body>

        <div class="type-25-content1">
            <div class="col-md-2">
